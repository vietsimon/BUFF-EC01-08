...
export default class OrderWebController extends BaseController {
    constructor() {
        super();
    ...
    private initGetRouter() {
        this._router.get("/v1/web/order/:id", this.getOrderDetail);
    }
    private initPostRouter() {
        this._router.post("/v1/web/order", AuthMiddleware.AuthCustomerJWT, this.createOrder);
    }
